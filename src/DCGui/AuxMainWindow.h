...
namespace DCGui
{
	class DCGUI_EXPORT AuxMainWindow : public IWindow
	{
		Q_OBJECT
	public:
		AuxMainWindow(QWidget *parent = 0, Qt::WindowFlags flags = Qt::WindowFlags());
	...
	private:
		...
		//加载菜单栏和工具栏,加载到模块名字对应的菜单下
		void LoadMenusAndToolBars(QString moduleName,QList<QMenu*> menus,
