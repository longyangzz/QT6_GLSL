...
#ifndef DCGUI_CONFIGPARSER_H
#define DCGUI_CONFIGPARSER_H
...
namespace DCGui
{
	...
	class ConfigParser
	{
		public:
			//数据库操作
			bool ConnectDatabaseWithoutPassword(QString& databaseName);
			...
			//! qss
			QString GetQssFileName();

			QString GetLicenseState();
